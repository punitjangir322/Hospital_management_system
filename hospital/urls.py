...
urlpatterns = [
    ...
    path('hospital/dashboard/admit-patient/', views.admit_patient, name='admit-patient'),
    path('hospital/dashboard/admitted-patient/', views.admitted_patient, name='admitted-patient'),
    path('hospital/dashboard/create-medicine-bill/', views.create_medicine_bill, name='create-medicine-bill'),
    path('hospital/dashboard/all-medicine-bill/', views.all_medicine_bill, name='all-medicine-bill'),
    path('hospital/dashboard/admitted-patient/edit-admitted/<int:admit_id>/', views.edit_admitted, name='edit-admitted'),
